...
void cover()                                    //cover page
{
	...
	settextstyle(10,0,4);
	outtextxy(230,140,"QUIZ");
	outtextxy(225,200,"GAME");

	for(i=(x-198);i<=(x+198);i++)             //loading graphic
		{
		delay(5);
		rectangle(x-200,y+150,x+200,y+160);
		rectangle(i,y+152,i,y+158);
		settextstyle(8,0,1);
		setcolor(15);
		outtextxy(x-40,y+170,"Loading...");
		}
...
int main()
     ...
     printf("\n\t\t Enter 'H' for help            \n");
     printf("\n\t\t Enter 'A' to know about this game\n");
     printf("\n\t\t Enter 'Q' to quit             \n");
     printf("\n\t\t-------------------------------\n\n\t\t  ");
 ...
 {
 clrscr();
 printf("This game is developed by BIT first semester student \n");
 printf("This our semester project \n");
 printf("Developed by @Sanotsh Nepal,@Pratik Ahdikari,@Mani maharjan\n");
 //printf("If you have any sugestion please mail us at santoshnepal608@gmail.com\n");
 getch();
 goto mainhome;
 }
    else if(choice=='S'){
